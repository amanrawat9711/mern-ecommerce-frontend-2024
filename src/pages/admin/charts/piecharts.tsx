...
const PieCharts = () => {
  ...
  const ageGroup = data?.charts.userAgeGroups!;
          ...
          <>
            ...
            <section>
              <div>
                <DoughnutChart
                  labels={
                    categories.map((i) => Object.keys(i)[0]) || []
                  }
                  data={
                    categories.map((i) => Object.values(i)[0]) || []
                  }
                  backgroundColor={
                    categories.map(
                      (i) => `hsl(${Object.values(i)[0] *Math.random() * 10}, ${Object.values(i)[0] *Math.random() * 10}%, 50%)`
                    ) || []
                  }
                  legends={false}
                  offset={[0, 0, 0, 80]}
